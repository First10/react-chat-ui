    ...
    _createClass(ChatFeed, [{
        ...
        value: function renderMessages(messages) {
            var _props = this.props,
                ...
                bubbleClassUser = _props.bubbleClassUser,
                bubbleClassBot = _props.bubbleClassBot,
                chatTitle = _props.chatTitle;
        ...
        value: function render() {
            ...
            var _props2 = this.props,
                ...
                messagesFeedClass = _props2.messagesFeedClass,
                chatTitle = _props2.chatTitle;

            return React.createElement("div", { id: "chat-panel", style: styles_1.default.chatPanel, className: "cb-chat-history-container" }, React.createElement("div", { ref: function ref(c) {
                    _this2.chat = c;
                }, className: "chat-history cb-chat-history", style: Object.assign({}, styles_1.default.chatHistory, { maxHeight: maxHeight }) }, React.createElement("p", { className: "cb-chat-title" }, chatTitle), React.createElement("div", { className: "chat-messages " + messagesFeedClass }, this.renderMessages(this.props.messages))), inputField);
        }
    }]);
