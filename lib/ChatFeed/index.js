    ...
    _createClass(ChatFeed, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { id: "chat-panel", style: styles_1.default.chatPanel, className: "cb-chat-history-container" }, React.createElement("div", { ref: function ref(c) {
                    _this2.chat = c;
                }, className: "chat-history cb-chat-history", style: Object.assign({}, styles_1.default.chatHistory, { maxHeight: maxHeight }) }, React.createElement("div", { className: "chat-messages " + messagesFeedClass }, this.renderMessages(this.props.messages))), inputField);
        }
    }]);
