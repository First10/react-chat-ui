...
var ChatBubble = function (_React$Component) {
    ...
    _createClass(ChatBubble, [{
        ...
        value: function render() {
            ...
            var chatBubbleClass = message.id === 0 ? bubbleClassBot : bubbleClassUser;
            if (message.message !== '' && message.message !== null) {
                return React.createElement("div", { style: Object.assign({}, styles_1.default.chatbubbleWrapper) }, React.createElement("div", { style: chatBubbleStyles, className: chatBubbleClass }, React.createElement("p", { style: Object.assign({}, styles_1.default.p, text) }, message.message)));
            }
            return null;
        }
    }]);
